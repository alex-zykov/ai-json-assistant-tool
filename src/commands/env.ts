        ...
        .action(async (options) => {
            try {
                ...
                const appConfig = {
                    ...
                    SCHEMA_PATH: process.env.SCHEMA_PATH || path.join(process.cwd(), 'schema.json'),
                    PROMPT_PATH: process.env.PROMPT_PATH || path.join(process.cwd(), 'prompt.json'),
                };
                ...
                if (options.validate) {
                    ...
                    const filesToCheck = [
                        { name: 'Schema', path: appConfig.SCHEMA_PATH, required: true },
